"""Convert Resident Handout HTML to A5 PDF using Playwright"""
import asyncio
...
async def convert_html_to_pdf():
    ...
    html_path = folder / "Reignite_Resident_Handout.html"
    pdf_path = folder / "Reignite_Resident_Handout_A5.pdf"
